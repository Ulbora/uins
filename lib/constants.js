...
//messages-------------------------------------------------------------
var DESC = "uins is an application for installing or updating node applications";
exports.DESC = DESC;

var INSTALL_COMMAND_SIGNATURE = "Install type: uins install nodeAppname ver=2.0(optional) path=/somePath(optional)";
exports.INSTALL_COMMAND_SIGNATURE = INSTALL_COMMAND_SIGNATURE;

var UPDATE_COMMAND_SIGNATURE = "Update type: uins update nodeAppname ver=2.0(optional) path=/somePath(optional)";
exports.UPDATE_COMMAND_SIGNATURE = UPDATE_COMMAND_SIGNATURE;

var PRESS_RETURN = "press return";
exports.PRESS_RETURN = PRESS_RETURN;

var HELP_MESSAGE = "type: uin --help";
