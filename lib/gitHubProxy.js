...
exports.getFileData = function (url, callback) {
    var returnVal = {
        success: false,
        message: "",
        jsonResponse: null
    };
    https.get({host: "api.github.com", path: "/repos/Ulbora/ulboracms/zipball/Version-2.0.12", headers: {"User-Agent: ": "node-installer"}}, function (res) {
        returnVal.success = true;
        returnVal.jsonResponse = res;
        callback(returnVal);
